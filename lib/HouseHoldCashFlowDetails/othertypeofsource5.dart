...
import 'othertypeofsource6.dart';

class othertypeofsource5 extends StatefulWidget {
  const othertypeofsource5({Key? key}) : super(key: key);

  @override
  State<othertypeofsource5> createState() => _othertypeofsource5State();
}

class _othertypeofsource5State extends State<othertypeofsource5> {
  ...
  TextEditingController _AvgDailyWages=TextEditingController();
  TextEditingController _AvgDailyWages2=TextEditingController();
              ...
              child: Column(
                children: [
                        ...
                        child: Row(
                          ...
                          children: [
                            ...
                            Expanded(
                              child: ABTextInput(
                                autoValidator: AutovalidateMode.onUserInteraction,
                                titleText: Strings.AvgDailyWages,
                                validator: (value) {
                                  if (value == null || value.isEmpty) {
                                    return 'Please enter Avg. Daily Wages';
                                  }
                                  return null;
                                },
                                controller: _AvgDailyWages,
                                hintText: "0",
                              ),
                            ),
                          ],
                  ...
                  ABButton(
                      ...
                      text: 'Save & Next',
                      onPressed: () {
                        Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) => othertypeofsource6(),));
                      }),
                ],
              ),
            ),
