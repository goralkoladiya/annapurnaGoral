...
class othertypeofsource6 extends StatefulWidget {
  const othertypeofsource6({Key? key}) : super(key: key);

  @override
  State<othertypeofsource6> createState() => _othertypeofsource6State();
}

class _othertypeofsource6State extends State<othertypeofsource6> {
  ...
  TextEditingController _ActivityName2=TextEditingController();
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Expanded(
                                child: ABTextInput(
                                  autoValidator: AutovalidateMode.onUserInteraction,
                                  titleText: Strings.ActivityName,
                                  validator: (value) {
                                    if (value == null || value.isEmpty) {
                        ...
                        Container(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              Container(height:50,child: OutlinedButton(style: OutlinedButton.styleFrom(side: BorderSide(color:kPrimaryColor)),onPressed: (){}, child: Text("Add More Income +",style: TextStyle(color: kPrimaryColor),)))
                            ],
                          ),
                        ),
                      ],
