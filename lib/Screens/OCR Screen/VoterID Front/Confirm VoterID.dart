...
import 'FinalVoterIDCard.dart';

class ConfirmVoterIdCard extends StatefulWidget {
  XFile? image;
  ConfirmVoterIdCard(this.image);

  @override
  State<ConfirmVoterIdCard> createState() => _ConfirmVoterIdCardState();
}

class _ConfirmVoterIdCardState extends State<ConfirmVoterIdCard> {
