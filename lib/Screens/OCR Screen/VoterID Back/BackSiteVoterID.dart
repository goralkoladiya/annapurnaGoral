...
import 'CropVoterID.dart';

class BackVoterIdCard extends StatefulWidget {
  const BackVoterIdCard({Key? key}) : super(key: key);

  @override
  State<BackVoterIdCard> createState() => _BackVoterIdCardState();
}

class _BackVoterIdCardState extends State<BackVoterIdCard> with WidgetsBindingObserver {
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text("Back of your voter ID",style: myTextstye ),
              ),
