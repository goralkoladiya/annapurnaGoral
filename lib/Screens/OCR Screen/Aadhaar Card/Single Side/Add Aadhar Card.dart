...
import 'Crop Aadhaar.dart';

class AddAadhaar extends StatefulWidget {
  const AddAadhaar({Key? key}) : super(key: key);

  @override
  State<AddAadhaar> createState() => _AddAadhaarState();
}

class _AddAadhaarState extends State<AddAadhaar> with WidgetsBindingObserver {
