...
import 'Add Aadhar Card.dart';
import 'Confirm Aadhaar.dart';

class CropAadhaar extends StatefulWidget {
  XFile? image;
  CropAadhaar(this.image);

  @override
  State<CropAadhaar> createState() => _CropAadhaarState();
}

class _CropAadhaarState extends State<CropAadhaar> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        centerTitle: true,
        backgroundColor: Color.fromRGBO(0, 0, 0, 0.7),elevation: 0,
