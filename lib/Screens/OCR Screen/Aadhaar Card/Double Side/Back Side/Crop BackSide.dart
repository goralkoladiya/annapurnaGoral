...
import 'package:annapurna225/Screens/OCR%20Screen/Aadhaar%20Card/Double%20Side/Back%20Side/Confirm%20BackSide.dart';
...
import 'AddBack Side.dart';

class CropBack2SAadhaar extends StatefulWidget {
  XFile? image;
  CropBack2SAadhaar(this.image);

  @override
  State<CropBack2SAadhaar> createState() => _CropBack2SAadhaarState();
}

class _CropBack2SAadhaarState extends State<CropBack2SAadhaar> {
              ...
              Row(mainAxisAlignment: MainAxisAlignment.spaceAround,
                children: [
                  ...
                  ElevatedButton(onPressed: () async {
                    ...
                    Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) {
                      return ConfirmBack2SAadhaar(img);
                    },));
                  },
