...
class ConfirmBack2SAadhaar extends StatefulWidget {
  final image;
  ConfirmBack2SAadhaar([this.image]);

  @override
  State<ConfirmBack2SAadhaar> createState() => _ConfirmBack2SAadhaarState();
}

class _ConfirmBack2SAadhaarState extends State<ConfirmBack2SAadhaar> {
