...
import 'Crop BackSide.dart';

class AddBack2SAadhaar extends StatefulWidget {
  const AddBack2SAadhaar({Key? key}) : super(key: key);

  @override
  State<AddBack2SAadhaar> createState() => _AddBack2SAadhaarState();
}

class _AddBack2SAadhaarState extends State<AddBack2SAadhaar> with WidgetsBindingObserver {
          ...
          child: Column(
            children: [
              Padding(
                ...
                child: Text("Back of Aadhar Card",style: myTextstye ),
              ),
              ...
              ElevatedButton(onPressed: () async {
                ...
                if (images != null) {
                  Navigator.pushReplacement(context, MaterialPageRoute(builder: (context) {
                    return CropBack2SAadhaar(images);
                  },));
                }
