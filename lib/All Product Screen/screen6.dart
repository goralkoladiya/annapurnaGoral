import 'package:annapurna225/All%20Product%20Screen/screen7.dart';
...
class _screen6State extends State<screen6> {
  ...
  TextEditingController downPayment1Controller=TextEditingController();
  ...
  TextEditingController totalDownPaymentNeedsToBePaidController=TextEditingController();
          ...
          children: [
            ...
            Padding(
              ...
              child: ExpansionTile(
                ...
                title: Text("Product - 1",style: TextStyle(color: black,fontWeight: FontWeight.bold)),
                children: [
                  Container(
                    color : Colors.white,
                    child: Column(
                      children: [
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(child: ABTextInput(
                              controller: totalProductPriceController,
                              autoValidator: AutovalidateMode.onUserInteraction,
                              titleText: "Total Product Price",
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please enter price';
                                }return null;
                                    ...
                                    child: OutlinedButton(
                                      ...
                                      child: Row(
                                        children: [
                                          ...
                                          Text("Add",style: TextStyle(color: kPrimaryColor,fontSize: 15.w,decoration: TextDecoration.underline),)
                                        ],
                                      ),
                                      onPressed: () {},
                                    ),
                        ...
                        Row(
                          children: [
                            ...
                            Expanded(child: ABTextInput(
                              controller: downPayment1Controller,
                              autoValidator: AutovalidateMode.onUserInteraction,
                              titleText: "Downpayment",
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                        ...
                        Row(
                          children: [
                            Expanded(child: ABTextInput(
                              controller: totalDownPaymentNeedsToBePaidController,
                              autoValidator: AutovalidateMode.onUserInteraction,
                              titleText: "Total Downpayment Needs To Be Paid",
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                  return 'Please enter payment';
                                }return null;
