import 'package:annapurna225/All%20Product%20Screen/screen3.dart';
...
class _screen2State extends State<screen2> {
  ...
  TextEditingController disabilityPercentageController=TextEditingController();
  TextEditingController disabilityCertificateNoController=TextEditingController();
          ...
          children: [
            ...
            Padding(
              ...
              child: ExpansionTile(
                ...
                textColor: Colors.black87,
                collapsedShape: RoundedRectangleBorder(borderRadius: BorderRadius.only(topLeft: Radius.circular(10),topRight: Radius.circular(10))),
                title: Text("${Strings.disabilityDetails}",style: TextStyle(color: black,fontWeight: FontWeight.bold)),
                children: [
                  Container(
                    color : Colors.white,
                    child: Column(
                      children: [
                        Row(
                          children: [
                            Expanded(child: ABTextInput(
                              ...
                              autoValidator: AutovalidateMode.onUserInteraction,
                              titleText: Strings.enterDisabilityType,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                            ...
                            Expanded(child: ABTextInput(
                              ...
                              autoValidator: AutovalidateMode.onUserInteraction,
                              titleText: Strings.enterDisabilityPercentage,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                        ...
                        Row(
                          children: [
                            Expanded(child: ABTextInput(
                              controller: disabilityCertificateNoController,
                              autoValidator: AutovalidateMode.onUserInteraction,
                              titleText: Strings.disabilityCertificateNo,
                              validator: (value) {
                                if (value == null || value.isEmpty) {
                                ...
                                child:Column(
                                  children: [
                                    Padding(
                                      ...
                                      child: Text("${Strings.disabilityCertificate}",style: TextStyle(fontWeight: FontWeight.w600,fontSize: 14)),
                                    ),
                                    Container(
                                      ...
                                      child: OutlinedButton(
                                        ...
                                        children: [
                                          ...
                                          Text("Capture Document",style: TextStyle(color: kPrimaryColor,fontSize: 10.h),)
                                        ],
                                      )),
                                    )
                                  ],
